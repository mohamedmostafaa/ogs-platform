/**
 * Hello-world landing page for the id app.
 *
...
export default function Page() {
  return (
    <main style={{ padding: "4rem", fontFamily: "system-ui, sans-serif" }}>
      <h1 style={{ fontSize: "2rem", fontWeight: 600 }}>OGS Identity</h1>
      <p style={{ marginTop: "0.75rem", color: "#666" }}>
        OGS workforce-trust platform — port 3000. Phase 0 hello-world shell.
      </p>
    </main>
  );
}
