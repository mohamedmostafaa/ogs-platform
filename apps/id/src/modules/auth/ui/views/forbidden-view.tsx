/**
 * `<ForbiddenView>` — landing page for `AuthGuardError`s.
 *
 * No data, no env. Guards redirect here when a user is signed in but
 * lacks the required role/feature for the page they tried to reach.
 *
 * @see Blueprint §6.8.
 */
