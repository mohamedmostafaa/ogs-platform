/**
 * `Sheet` — shadcn/ui side panel (slide-over).
 *
 * Wraps Radix Dialog with a directional `side` prop (top/right/bottom/
 * left). Use for nav drawers, filter pickers, mobile alternatives to
 * dropdowns.
 *
